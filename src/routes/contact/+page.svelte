        ...
        <div class="md:w-1/2 bg-gray-50 p-8 rounded-lg">
          ...
          <div class="mt-12">
            ...
            <div class="flex space-x-4">
              ...
              <a href="https://github.com/LeeSomm/" class="w-10 h-10 bg-gray-700 rounded-full flex items-center justify-center text-white hover:bg-gray-800" aria-label="GitHub">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
