<script lang="ts">
    // Accept all the functions and variables as props
    export let getPrefectureColor: (id: string) => string;
    export let getPrefectureStroke: (id: string) => string;
    export let getPrefectureOpacity: (id: string) => number;
    export let handleMouseEnter: (event: MouseEvent, id: string) => void;
    export let handleMouseLeave: () => void;
    export let handleMouseMove: (event: MouseEvent) => void;
    export let handleClick: (id: string) => void;
    export let handleKeyDown: (event: KeyboardEvent, id: string) => void;
...
<svg
    ...
    <path
        ...
        {...(interactive ? {
            ...
            onclick: () => handleClick('JP-23'),
            onkeydown: (e) => handleKeyDown(e, 'JP-23'),
            'tabindex': 0,
            'role': 'button',
    ...
    <path
        ...
        {...(interactive ? {
            ...
            onmouseleave: handleMouseLeave,
            onmousemove: handleMouseMove,
            onclick: () => handleClick('JP-05'),
            onkeydown: (e) => handleKeyDown(e, 'JP-05'),
            'tabindex': 0,
            'role': 'button',
            'aria-label': 'Akita Prefecture'
        } : {})}
    />
    <path
        ...
        {...(interactive ? {
            ...
            onmouseleave: handleMouseLeave,
            onmousemove: handleMouseMove,
            onclick: () => handleClick('JP-02'),
            onkeydown: (e) => handleKeyDown(e, 'JP-02'),
            'tabindex': 0,
            'role': 'button',
            'aria-label': 'Aomori Prefecture'
        } : {})}
    />
    <path
        ...
        {...(interactive ? {
            ...
            onmouseleave: handleMouseLeave,
            onmousemove: handleMouseMove,
            onclick: () => handleClick('JP-12'),
            onkeydown: (e) => handleKeyDown(e, 'JP-12'),
            'tabindex': 0,
            'role': 'button',
            'aria-label': 'Chiba Prefecture'
        } : {})}
    />
    <path
        ...
        fill={getPrefectureColor('JP-38')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-38'),
                onkeydown: (e) => handleKeyDown(e, 'JP-38'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Ehime Prefecture'
            } : {})}
    />
    <path
        ...
        fill={getPrefectureColor('JP-18')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-18'),
                onkeydown: (e) => handleKeyDown(e, 'JP-18'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Fukui Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-40')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-40'),
                onkeydown: (e) => handleKeyDown(e, 'JP-40'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Fukuoka Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-07')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-07'),
                onkeydown: (e) => handleKeyDown(e, 'JP-07'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Fukushima Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-21')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-21'),
                onkeydown: (e) => handleKeyDown(e, 'JP-21'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Gifu Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-10')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-10'),
                onkeydown: (e) => handleKeyDown(e, 'JP-10'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Gunma Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-28')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-28'),
                onkeydown: (e) => handleKeyDown(e, 'JP-28'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Hyogo Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-01')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-01'),
                onkeydown: (e) => handleKeyDown(e, 'JP-01'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Hokkaido Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-34')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-34'),
                onkeydown: (e) => handleKeyDown(e, 'JP-34'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Hiroshima Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-08')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-08'),
                onkeydown: (e) => handleKeyDown(e, 'JP-08'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Ibaraki Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-17')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-17'),
                onkeydown: (e) => handleKeyDown(e, 'JP-17'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Ishikawa Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-03')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-03'),
                onkeydown: (e) => handleKeyDown(e, 'JP-03'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Iwate Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-39')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-39'),
                onkeydown: (e) => handleKeyDown(e, 'JP-39'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Kochi Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-37')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-37'),
                onkeydown: (e) => handleKeyDown(e, 'JP-37'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Kagawa Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-43')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-43'),
                onkeydown: (e) => handleKeyDown(e, 'JP-43'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Kumamoto Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-14')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-14'),
                onkeydown: (e) => handleKeyDown(e, 'JP-14'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Kanagawa Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-46')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-46'),
                onkeydown: (e) => handleKeyDown(e, 'JP-46'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Kagoshima Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-26')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-26'),
                onkeydown: (e) => handleKeyDown(e, 'JP-26'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Kyoto Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-24')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-24'),
                onkeydown: (e) => handleKeyDown(e, 'JP-24'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Mie Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-04')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-04'),
                onkeydown: (e) => handleKeyDown(e, 'JP-04'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Miyagi Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-45')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-45'),
                onkeydown: (e) => handleKeyDown(e, 'JP-45'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Miyazaki Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-15')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-15'),
                onkeydown: (e) => handleKeyDown(e, 'JP-15'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Niigata Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-20')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-20'),
                onkeydown: (e) => handleKeyDown(e, 'JP-20'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Nagano Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-29')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-29'),
                onkeydown: (e) => handleKeyDown(e, 'JP-29'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Nara Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-42')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-42'),
                onkeydown: (e) => handleKeyDown(e, 'JP-42'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Nagasaki Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-47')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-47'),
                onkeydown: (e) => handleKeyDown(e, 'JP-47'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Okinawa Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-27')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-27'),
                onkeydown: (e) => handleKeyDown(e, 'JP-27'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Osaka Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-33')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-33'),
                onkeydown: (e) => handleKeyDown(e, 'JP-33'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Okayama Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-44')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-44'),
                onkeydown: (e) => handleKeyDown(e, 'JP-44'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Oita Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-41')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-41'),
                onkeydown: (e) => handleKeyDown(e, 'JP-41'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Saga Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-25')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-25'),
                onkeydown: (e) => handleKeyDown(e, 'JP-25'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Shiga Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-32')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-32'),
                onkeydown: (e) => handleKeyDown(e, 'JP-32'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Shimane Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-11')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-11'),
                onkeydown: (e) => handleKeyDown(e, 'JP-11'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Saitama Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-22')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-22'),
                onkeydown: (e) => handleKeyDown(e, 'JP-22'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Shizuoka Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-09')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-09'),
                onkeydown: (e) => handleKeyDown(e, 'JP-09'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Tochigi Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-13')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-13'),
                onkeydown: (e) => handleKeyDown(e, 'JP-13'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Tokyo Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-36')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-36'),
                onkeydown: (e) => handleKeyDown(e, 'JP-36'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Tokushima Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-31')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-31'),
                onkeydown: (e) => handleKeyDown(e, 'JP-31'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Tottori Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-16')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-16'),
                onkeydown: (e) => handleKeyDown(e, 'JP-16'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Toyama Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-30')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-30'),
                onkeydown: (e) => handleKeyDown(e, 'JP-30'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Wakayama Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-35')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-35'),
                onkeydown: (e) => handleKeyDown(e, 'JP-35'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Yamaguchi Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-19')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-19'),
                onkeydown: (e) => handleKeyDown(e, 'JP-19'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Yamanashi Prefecture'
            } : {})}
        />
    <path
        ...
        fill={getPrefectureColor('JP-06')}
            ...
            {...(interactive ? {
                ...
                onmouseleave: handleMouseLeave,
                onmousemove: handleMouseMove,
                onclick: () => handleClick('JP-06'),
                onkeydown: (e) => handleKeyDown(e, 'JP-06'),
                'tabindex': 0,
                'role': 'button',
                'aria-label': 'Yamagata Prefecture'
            } : {})}
        />
</svg>
